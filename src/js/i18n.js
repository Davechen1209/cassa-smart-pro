...
const translations = {
  it: {
    ...
    'voice.needKey': 'Serve la tua API key OpenAI (Impostazioni › Fatture & AI).',
    'voice.needKeyLong': 'Per usare il contabile vocale inserisci la tua API key OpenAI in Impostazioni › Fatture & AI. È la stessa chiave usata per leggere le fatture dalle foto.',
  ...
  zh: {
    ...
    'voice.needKey': '需要你的 OpenAI API 密钥（设置 › 账单与AI）。',
    'voice.needKeyLong': '使用语音会计前，请在 设置 › 账单与AI 中填写你的 OpenAI API 密钥。与拍照识别账单用的是同一把密钥。',
