...
const translations = {
  ...
  zh: {
    ...
    'backup.importedFatture': '已导入 {n} 张发票！',
    'backup.totalFatture': '共 {n} 张发票',
    'backup.excelFattureTitle': '从Excel导入发票',
    'backup.excelFattureHelp': '列：日期、编号、公司、金额、付款方式、到期日、备注',
    ...
    'fatt.paid': '已付款',
    'fatt.unpaid': '待付: ',
    'fatt.unpaidLabel': '待付款',
    'fatt.markPaid': '标记为已付款',
    'fatt.markUnpaid': '标记为未付款',
    'fatt.markedPaid': '发票已标记为已付款',
    'fatt.markedUnpaid': '发票已重新打开',
